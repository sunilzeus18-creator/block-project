...
const AdminLogin = ({ onLoginSuccess, onBack }) => {
  ...
  const demoCreds = { username: 'admin', password: 'admin@123' };
  ...
  return (
    <div className="login-form">
      ...
      <p style={{ textAlign: 'center', color: 'rgba(255,255,255,0.9)' }}>
        Connected to Blockchain Backend
      </p>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <input
          ...
          required
        />
        <button type="submit" className="login-btn admin-login-btn" disabled={loading}>
